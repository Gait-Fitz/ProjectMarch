...
from .dynamic_setpoint_gait import DynamicSetpointGait


class DynamicSetpointGaitFixed(DynamicSetpointGait):
    """Gait based on dynamic setpoint gait, with a fixed step size.
