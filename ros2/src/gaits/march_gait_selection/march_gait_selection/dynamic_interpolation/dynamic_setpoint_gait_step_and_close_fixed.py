...
from .dynamic_setpoint_gait_step_and_close import DynamicSetpointGaitStepAndClose


class DynamicSetpointGaitStepAndCloseFixed(DynamicSetpointGaitStepAndClose):
    """Step and close gait based on dynamic setpoint gait, with a fixed step size.
