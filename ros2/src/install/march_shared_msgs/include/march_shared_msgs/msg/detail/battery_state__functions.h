...
#ifndef MARCH_SHARED_MSGS__MSG__DETAIL__BATTERY_STATE__FUNCTIONS_H_
#define MARCH_SHARED_MSGS__MSG__DETAIL__BATTERY_STATE__FUNCTIONS_H_
 ...
 * calls
 * march_shared_msgs__msg__BatteryState__init().
...
/**
 * It calls
 * march_shared_msgs__msg__BatteryState__fini()
 ...
 * march_shared_msgs__msg__BatteryState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * march_shared_msgs__msg__BatteryState__Sequence__fini()
 * on the array,
...
#endif  // MARCH_SHARED_MSGS__MSG__DETAIL__BATTERY_STATE__FUNCTIONS_H_
