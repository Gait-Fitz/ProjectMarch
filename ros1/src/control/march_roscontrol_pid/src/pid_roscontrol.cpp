...
bool PidControllerInterface::init(
...
void PidControllerInterface::starting(const ros::Time& /*time*/)
{
...
void PidControllerInterface::updateCommand(const ros::Time& /*time*/,
...
// controller manager
void PidControllerInterface::stopping(const ros::Time& /*time*/)
{
    // zero commands
    for (int i = 0; i < num_joints_; ++i) {
        (*joint_handles_ptr_)[i].setCommand(/*command=*/0.0);
...
namespace roscontrol_pid_controller {
...
PLUGINLIB_EXPORT_CLASS(
    roscontrol_pid_controller::JointTrajectoryController,
